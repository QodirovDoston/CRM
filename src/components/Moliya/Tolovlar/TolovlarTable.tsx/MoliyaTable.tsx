import { buttonsForMoliya, group ,section1} from "../../../../utils/Constants"
...
export default function MoliyaTable() {
  ...
  return (
    <>
      <main className='pb-5 pt-2 items-center px-1 my-2'>
        ...
        {/* table */}
        <div className="px-2 py-4  mt-5  mb-[-25px] gap-1 overflow-y-scroll h-[220px]  scrol">
