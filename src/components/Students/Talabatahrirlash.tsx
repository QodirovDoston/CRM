...
// const Talabatahrirlash = ({ closeFunction }: { closeFunction: any, byId: any }) => {
...
//     // const getByTalabalar = async (id: any) => {
...
//                         <div className="pb-[20px]">
//                             <h3>Izoh</h3>
//                             <textarea placeholder="Comment..." className='border-[1px] border-[#444] rounded-[15px] w-full h-[80px] mt-[10px] p-[10px]' {...register("comment")}></textarea>
//                         </div>
//                         <div className="pb-[20px]">
//                             <h3>Parol bering</h3>
...
//                             </div>
//                         </div>
//                         <button type='submit' className='py-[13px] mb-5 px-[20px] inline-flex items-center justify-center rounded-[15px] bg-[#F48221] text-[#fff]' onClick={() => { closeFunction(false) }}>
