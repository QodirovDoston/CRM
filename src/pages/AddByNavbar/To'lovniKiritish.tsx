...
const TolovKritish = ({ setShow1, show1 }: any) => {
            ...
            <div className='flex justify-start '>
                <div className='w-[485px]'>
                    <div className="py-[21px] pl-[16px] flex gap-32 px-5">
                        <h3 className='text-[#F48221] text-[17px] font-bold flex items-center'>To'lovni kiritish</h3>
                        <button className='bg-[#F48221] fa-solid fa-xmark text-[#fff] w-[40px] h-[40px] flex items-center justify-center rounded-[5px]' onClick={() => setShow1(!show1)}></button>
                    </div>
